...
def main():
    ...
    parser.add_argument('--pca', type=int, default=models.Defaults.pca_components,
    ...
    parser.add_argument('--image_size', type=int, default=models.Defaults.image_size)
    ...
    score = score_model(args.model, layers=args.layers, model_weights=args.model_weights,
