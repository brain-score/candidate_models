...
def main():
    data = DataCollector()()
    data = data[data['benchmark'] == 'dicarlo.Majaj2015.temporal-mean.IT']
    ceiling = benchmarks.load('dicarlo.Majaj2015.temporal-mean.IT').ceiling
    ...
    ax.legend()
    pyplot.savefig('results/temporal.png')
