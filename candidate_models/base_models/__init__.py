...
class BaseModelPool(UniqueKeyDict):
    ...
    def __init__(self):
        ...
        _key_functions = {
            ...
            'resnext101_32x8d_wsl': lambda: wsl('resnext101_32x8d_wsl'),
            'resnext101_32x16d_wsl': lambda: wsl('resnext101_32x16d_wsl'),
            'resnext101_32x32d_wsl': lambda: wsl('resnext101_32x32d_wsl'),
            'resnext101_32x48d_wsl': lambda: wsl('resnext101_32x48d_wsl'),
