from candidate_models.base_models import base_model_pool, stochastic_model_pool
...
from candidate_models.model_commitments.stochastic import StochasticBrainPool
...
stochastic_brain_pool = StochasticBrainPool(stochastic_model_pool, model_layers)

for identifier, model in ml_brain_pool.items():
    brain_translated_pool[identifier] = model

for identifier, model in stochastic_brain_pool.items():
    brain_translated_pool[identifier] = model
